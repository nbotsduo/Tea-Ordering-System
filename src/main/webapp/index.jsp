    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="loginSelector.jsp">Login</a></li>
      ...
      <div class="home__header-content">
        <div id="main-home-carousel" class="owl-carousel">
          <div>
            ...
            <p class="intro-text">For those who want any type of tea <br/>  We got your back for varieties of tea's!</p>
            <a class="btn btn-custom" href="#">Get sipping!</a>
