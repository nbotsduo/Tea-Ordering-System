...
<tr>
							...
							<td>
								<center>
									<a href="CreateOrderUser1?action=createOrderUser.jsp" class="btn btn-primary">Create New Order</a> 
								</center>
							</td>
						</tr>
					<c:forEach items="${orderList}" var="order">
						<tr>
							...
							<td><c:out value="${order.order_name}" /></td>
							<td><c:out value="${order.price}" /></td>
							<td><c:out value="${order.order_time}" /></td>
							<td><c:out value="${order.pickup_time}" /></td>
							<td><c:out value="${order.status}" /></td>
							<td>
								<center>
									<a href="ViewDetailedOrderUserController?order_id=<c:out value="${order.order_id}" />" class="btn btn-primary">View</a> 
									<a href="DeleteOrderUserController?action=delete&order_id=<c:out value="${order.order_id}"/>&user_id=<c:out value="${order.user_id}" />" class="btn btn-danger">Delete</a>
