				...
				<tbody>
					...
					<c:forEach items="${orderList}" var="order">
						<tr>
							...
							<td>
								<center>
									<a href="ViewDetailedOrderAdminController?order_id=<c:out value="${order.order_id}" />" class="btn btn-primary">View</a> 
									<a href="UpdateOrderStatusAdminController?order_id=<c:out value="${order.order_id}"/>" class="btn btn-warning">Complete</a> 
									<a href="DeleteOrderAdminController?action=delete&order_id=<c:out value="${order.order_id}"/>" class="btn btn-danger">Delete</a>
