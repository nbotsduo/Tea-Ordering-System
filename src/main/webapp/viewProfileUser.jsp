...
<head>
    ...
    <meta charset="utf-8" />
    <!-- Site Title-->
    <title>View Profile | Kedai Teh</title>
    ...
    <section>
        <div class="form">
            <form>
                ...
                <div class="form-group row">
                    <label for="Type of Tea" class="col-sm-2 col-form-label">Name</label>
                    <div class="col-sm-5">
                        <c:out value="${u.name}"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Type of Tea" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-5">
                        <c:out value="${u.username}"/>
                    </div>
                </div>
                <div class="form-group row ">
                    <label for="quantity" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-1">
                        <c:out value="${u.email}"/>
                    </div>
                </div>
                <div class="form-group row ">
                    <label for="pickUp" class="col-sm-2 col-form-label">Birthdate</label>
                    <div class="col-sm-1">
                        <c:out value="${u.birthdate}"/>
                    </div>
                </div>
                <a href="UpdateProfileUserController?action=updateProfileUser.jsp&user_id=<%=session.getAttribute("user_id")%>" class="btn btn-warning">Modify Profile</a>
            </form>
        </div>
    </section>
    <script>
